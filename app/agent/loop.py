    ...
    blocks: list[dict[str, Any]] = [
        {
            ...
            "text": (
                ...
                "- Knowledge base: call get_kb_index first to see what documents exist, then "
                "read_kb_source to read the most relevant one(s) in full — this is the primary "
                "way to answer from the user's personal context, projects, or notes. Use "
                "search_knowledge_base only for broad or uncertain queries where you don't know "
                "which document holds the answer. Use web_search when the knowledge base has "
                "nothing useful or the topic requires current information.\n"
